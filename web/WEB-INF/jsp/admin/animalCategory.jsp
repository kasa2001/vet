...
<section class="container">
    <div class="mt-3 mb-3">
        <main id="main" class="card-body bg-light radius">
            <h1 class="text-center" >Dodaj typ zwierzaka :)</h1>
            <form:form modelAttribute="animalType">
                <div class="form-group">
                    <label for="name" class="bmd-label-floating">Rasa zwierzaka:</label>
                    <form:input path="name" cssClass="form-control" cssErrorClass="form-control is-invalid"/>
                    <form:errors path="name" cssClass="error text-danger" element="div"/>
                </div>
                <button type="submit" class="btn btn-primary btn-raised">Dodaj rasę</button>
            </form:form>
        </main>
    </div>
</section>
